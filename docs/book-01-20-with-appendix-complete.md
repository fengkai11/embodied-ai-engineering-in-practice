...
```text
assets/images/ch01_xxx.png
```

则图片引用可以写成：

```markdown
![图示](../../assets/images/ch01_xxx.png)
```
...
本附录提供按主题组织的索引，帮助读者快速回到相关章节。

---

## A

- ACT：第 4 章、第 16 章、附录 E
- Action：第 3 章、第 16 章
- Action Chunk：第 4 章、第 16 章、附录 E
- Autonomous Driving：第 1–2 章、第 20 章

## B

- base_link：第 11 章
- Behavior Cloning：第 4 章、附录 E

## C

- camera_link：第 11 章
- Collision Rate：第 17 章
- Completion Time：第 17 章

## D

- Dataset：第 7、15 章
- dataset_v0：第 15–16 章
- dataset_v1：第 18 章
- Diffusion Policy：第 4 章、附录 E
- Data Closed Loop：第 2、18 章

## E

- Embodied AI：第 1 章
- end_effector：第 11–12 章
- Episode：第 3、7 章
- Evaluation：第 17 章

## F

- Failure Reason：第 17–18 章
- Failure Taxonomy：第 18 章
- FK / IK：第 12 章

## G

- GitHub 作品集：第 20 章、附录 G
- GR00T：附录 C

## I

- Imitation Learning：第 4 章
- Intervention Rate：第 14、17 章
...
- mdBook：附录 G
- MoveIt2：第 12 章
- Mobile Manipulation：第 19 章

## O

- Observation：第 3 章
- Open X-Embodiment：附录 C
- OpenVLA：附录 C
...
- Scripted Expert：第 13 章
- Shelf Anomaly：第 19 章
- Success Rate：第 17 章

## T

- Teleoperation：第 14 章
- TF：第 11 章
- Train / Val / Test：第 15 章

## V

- VLA：第 5 章、附录 C
- VLM：第 5 章
- Vision-Language-Action：第 5 章、附录 C
